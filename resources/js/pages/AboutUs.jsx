    ...
    <div className="card" style={{ padding: '40px', maxWidth: '1000px', margin: '0 auto' }}>
      <div style={{ textAlign: 'center', marginBottom: 50 }}>
        ...
        <p style={{ color: 'var(--text-muted)', fontSize: '1.2rem', maxWidth: '600px', margin: '0 auto' }}>
          Empowering businesses with cutting-edge digital management solutions since 2024.
        </p>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 30, marginBottom: 50 }}>
        <div className="stat-card" style={{ padding: '30px', background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 16 }}>
          ...
          <p style={{ color: 'var(--text-muted)', lineHeight: 1.6 }}>
            To simplify complex inventory and billing workflows for store owners, allowing them to focus on growth rather than paperwork. We aim to bridge the gap between traditional retail and modern digital efficiency.
          </p>
        </div>
        ...
        <div className="stat-card" style={{ padding: '30px', background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 16 }}>
          ...
          <p style={{ color: 'var(--text-muted)', lineHeight: 1.6 }}>
            To become the global standard for SME retail management systems, fostering a world where every local shop has access to enterprise-grade tools.
          </p>
        </div>
      </div>
      ...
      <section style={{ marginBottom: 50 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 20 }}>
          {[
            ...
            { icon: Zap, title: "Efficiency", desc: "Our tools are optimized for speed, even on low-spec retail." },
