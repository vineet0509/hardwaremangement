...
Route::post('/bills/{bill}/razorpay-link', [BillController::class, 'generatePaymentLink']);
Route::post('/bills/{bill}/razorpay-verify', [BillController::class, 'verifyPaymentStatus']);
